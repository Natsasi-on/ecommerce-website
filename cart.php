...
<link rel="stylesheet" href="./common/styles/waitlist.css">
<section>
    <h1>My Cart</h1>
    <div class="list-item">
        <form method="" action="" class="table-width">
            <table>
                <thead>
                    <th>Products</th>
                    <th>Images</th>
                ...
                <tbody>
                    <tr>
                        <td>Hand Watch</td>
                        <td><img src="./common/images/bag.png" height="100px" alt="man-bag"></td>
                        <td>$50.00</td>
                        <td>1</td>
                        <td>$50.00</td>
                        <td>
            ...
            <div class="button-container">
                <button class="btn more"><a href="product.html">More Products</a></button>
